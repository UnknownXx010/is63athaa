            ...
            <div class="col-10 m-auto">
                <div class="card shadow p-3 mb-5 bg-body-tertiary rounded">
                    <div class="card-header">
                        <b>Gelombang Pendaftaran SISWA</b>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Gelombang Pendaftaran</th>
                                    ...
                                    <td>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-header bg-warning">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Data Detail Jurusan</h1>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                Yakin Data Dengan Nama <?=$data['gelombang']?> Ingin Dihapus?
                                            </div>
                                            <div class="modal-footer">
